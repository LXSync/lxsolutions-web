    ...
    <form className="cf2-form" onSubmit={submit} noValidate>
      ...
      <div className="cf2-field">
        ...
        <select className="cf2-sel" value={form.division} onChange={e => set('division', e.target.value)}>
          ...
          <option value="LXSYNC">LXSYNC — Automatización e IA</option>
          <option value="LXMEDIA">LXMEDIA — YouTube &amp; Contenido</option>
          <option value="LXVIRAL">LXVIRAL — Redes Sociales</option>
          <option value="multiple">Varias divisiones</option>
          <option value="unknown">No lo tengo claro aún</option>
        </select>
      </div>
      <div className="cf2-field">
